...
namespace WpfAnimationTest
{
  public partial class MainWindow
  {
    ...
    private void MainWindowLoaded(object sender, RoutedEventArgs e)
    {
      ...
      BarDescriptor barFive = new BarDescriptor
      {
        RectangleX = 0,
        RectangleY = 0,
        RectangleWidth = 800,
      ...
      BarDescriptor barSix = new BarDescriptor
      {
        RectangleX = 0,
        RectangleY = 0,
        RectangleWidth = 800,
      ...
      BarDescriptor barSeven = new BarDescriptor
      {
        RectangleX = 0,
        RectangleY = 0,
        RectangleWidth = 800,
      ...
      BarDescriptor barEight = new BarDescriptor
      {
        RectangleX = 0,
        RectangleY = 0,
        RectangleWidth = 800,
      ...
      CreateRectangleAnimatedRectangle(barFive);
      CreateRectangleAnimatedRectangle(barSix);
      CreateRectangleAnimatedRectangle(barSeven);
      CreateRectangleAnimatedRectangle(barEight);
    }

    private void CreateRectangleAnimatedRectangle(BarDescriptor inputParameters)
    {
      DoubleAnimation firstStopAnim = new DoubleAnimation(0.01, 0.95, new Duration(new TimeSpan(0, 0, 0, inputParameters.AnimationTimeInSeconds)));
      DoubleAnimation secondStopAnim = new DoubleAnimation(0.02, 0.96, new Duration(new TimeSpan(0, 0, 0, inputParameters.AnimationTimeInSeconds)));
      DoubleAnimation thirdStopAnim = new DoubleAnimation(0.03, 0.97, new Duration(new TimeSpan(0, 0, 0, inputParameters.AnimationTimeInSeconds)));
      DoubleAnimation fourthStopAnim = new DoubleAnimation(0.04, 0.98, new Duration(new TimeSpan(0, 0, 0, inputParameters.AnimationTimeInSeconds)));
      DoubleAnimation fifthStopAnim = new DoubleAnimation(0.05, 0.99, new Duration(new TimeSpan(0, 0, 0, inputParameters.AnimationTimeInSeconds)));
      ...
      {
        new GradientStop(Color.FromScRgb(0.0f, inputParameters.BarBaseRedLevel, inputParameters.BarBaseGreenLevel, inputParameters.BarBaseBlueLevel), 0.0),
        ...
        new GradientStop(Color.FromScRgb(0.0f, inputParameters.BarBaseRedLevel, inputParameters.BarBaseGreenLevel, inputParameters.BarBaseBlueLevel), 1.0),
      };
      ...
      LinearGradientBrush gradientBrush = new LinearGradientBrush(gradientStops, 
        new Point(inputParameters.GradientStartX, inputParameters.GradientStartY), 
        new Point(inputParameters.GradientEndX, inputParameters.GradientEndY));
    ...
    private string RandomName()
    {
      ...
      temp = Regex.Replace(temp, @"[\d-]", string.Empty).ToUpper();
      return new string(Enumerable.Repeat(chars, nameLen).Select(s => s[random.Next(s.Length)]).ToArray()) + temp;
    }
  }
}
